  ...
  return (
    <Box sx={{}}>
      ...
      <Box>
        ...
        <Divider sx={{ mb: 2 }} />
        <Box sx={{ display: 'flex', mb: 1, fontWeight: 'bold', color: 'text.secondary' }}>
        ...
        {dashboards.map((dashboard, index) => (
          ...
          >
            <Box sx={{ flex: 2 }}>{dashboard.name}</Box>
            <Box sx={{ flex: 2 }}>{dashboard.location}</Box>
            <Box sx={{ flex: 1 }}>{dashboard.dateViewed}</Box>
            <Box sx={{ flex: 1 }}>{dashboard.dateUpdated}</Box>
            <Box sx={{ flex: 1 }}>{dashboard.owner}</Box>
